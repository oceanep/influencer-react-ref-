    	...
    	return(
              this.props.complete ?
          	    <Row >
                    ...
                    <Col className="profile-app-title" span={2}>
                      <div ><img width="70px" style={{paddingTop: '30%'}} src={chrome.runtime.getURL("images/influencer-logo1x.svg")}/></div>
              ...
              :
                <Row >
                  ...
                  <Col className="profile-app-title" span={2}>
                    <div ><img width="70px" style={{paddingTop: '30%', paddingLeft: '0'}} src={chrome.runtime.getURL("images/influencer-logo1x.svg")}/></div>
                    {/*<div ><img width="70px" style={{paddingTop: '30%'}} src={"images/influencer-logo1x.svg"}/></div>*/}
                  </Col>
                </Row>
    	)
