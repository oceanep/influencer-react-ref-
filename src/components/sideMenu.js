...
const SideMenu = (props) => {
	...
	return (
		...
		<Menu.Item key='0' className="menuItem">
                  <span>
                    <Icon type="youtube" /><span>Media</span>
                  </span>
                </Menu.Item>

		<Menu.Item key='1' className="menuItem">
                  <span>
                    <Icon type="youtube" /><span>Mentions</span>
                  </span>
                </Menu.Item>
                
		<Menu.Item key='2' className="menuItem">
                  <span>
                    <Icon type="youtube" /><span>Hashtags</span>
                  </span>
                </Menu.Item>
                
		<Menu.Item key='3' className="menuItem">
                  <span>
                    <Icon type="youtube" /><span>Image Content</span>
                  </span>
                </Menu.Item>
                
		<Menu.Item key='4' className="menuItem">
                  <span>
                    <Icon type="youtube" /><span>Tagged Locations</span>
                  </span>
                </Menu.Item>

		<Menu.Item key='5' className="menuItem">
                  <span>
                    <Icon type="youtube" /><span>Brand Patterns</span>
                  </span>
                </Menu.Item>
